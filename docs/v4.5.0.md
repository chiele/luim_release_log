...
#### 2️⃣  修改洞察官定价规则（天猫价格*1.05并且尾数置9，淘宝价格尾数置9，外仓价格取相同货号中的最大值）。
...
#### 2️⃣  售后单列表新增批量刷新售后单按钮。
![6](https://luim-public.oss-cn-zhangjiakou.aliyuncs.com/release_docs/v4.5.0/6.png)
